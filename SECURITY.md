...
Replace this section with the supported versions for `../bugrepro`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `../bugrepro` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ../bugrepro.
